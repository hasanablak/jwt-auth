...
class ChangeEmailSendCodeToNewEmail extends Notification implements ShouldQueue
{
	use Queueable;
	...
	public function via($notifiable)
	{
		...
		$this->mailData["newEmailAddress"] = $notifiable->routes["mail"];

		return ['mail', '_database'];
	}
	...
	public function toMail()
	{
		return (new MailMessage)
			...
			->greeting(__("jwt-auth.change-email.subject"))
			->line(__("jwt-auth.change-email.new.line1"))
